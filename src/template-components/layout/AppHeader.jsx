...
import { fetchCurrentUser, logoutSession } from "@/lib/actions/user-actions";
...
const AppHeader = () => {
  ...
  return (
    <header className="sticky top-0 flex w-full border-white/10 z-99999 bg-Plum/20 backdrop-blur-lg lg:border-b">
      <div className="flex flex-col items-center justify-between flex-grow lg:flex-row lg:px-6">
        <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-white/10 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
          <button
            className="items-center justify-center w-10 h-10 text-gray-500 border-white/10 rounded-lg z-99999 lg:flex dark:text-gray-400 lg:h-11 lg:w-11 lg:border"
